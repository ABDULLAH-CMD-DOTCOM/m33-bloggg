  ...
  return (
    ...
    <div className="max-w-screen-lg mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-[#a5a58d]">About Our Blog</h1>
        <p className="text-lg text-white mt-4">
          Welcome to AR Blog, your go-to destination for everything related to modern web development, design, and emerging technologies. Whether youre a beginner or an advanced professional, our blog is designed to help you stay up-to-date with the latest trends, tools, and techniques in the tech world.
          <br />
          <br />
      ...
      {/* About Me Section */}
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-[#a5a58d]">About Me</h2>
        <p className="text-lg text-white mt-4">
          Hello! Iam Muhammad Abdullah, a passionate Frontend Developer with a deep love for building interactive and visually appealing web applications. I am student at GIAIC where I am exploring AgenticAI and GenAI and currently, I am student of class first year.
          <br />
          <br />
      ...
      {/* About AR Section */}
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-[#a5a58d]">About Trendverse</h2>
        <p className="text-lg text-white mt-4">
          AR is an emerging technology startup founded with the goal of revolutionizing the world of web development and design. As a team of passionate individuals, we strive to create innovative solutions that push the boundaries of modern technology and provide our clients with the tools they need to succeed in the digital age.
          <br />
          <br />
          At AR, we are focused on leveraging cutting-edge technologies to deliver high-quality products and services. Our team is composed of individuals who have a strong passion for coding, designing, and developing solutions that are not only functional but also aesthetically pleasing and user-friendly.
        </p>
      </div>

      {/* Why Choose AR Section */}
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-[#a5a58d] mb-6">Why Choose Trendverse?</h2>
