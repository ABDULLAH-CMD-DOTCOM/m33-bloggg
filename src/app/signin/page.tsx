  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen p-y-[20px] mt-[30px] mb-[30px]">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
        ...
        {/* Heading */}
        <h1 className="text-[24px] text-[#a5a58d] font-[600] text-center mb-6">
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 mt-6 bg-[#a5a58d] text-white text-lg font-semibold rounded-md hover:bg-[#c6c5b9] focus:outline-none focus:ring-2 focus:ring-blue-950"
          >
            Sign In
          </button>
        </form>
